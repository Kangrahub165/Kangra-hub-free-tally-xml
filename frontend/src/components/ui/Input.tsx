      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            id={inputId}
            className={`w-full bg-white text-sm text-slate-900 placeholder:text-slate-400/80 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500/25 focus:border-brand-500 disabled:bg-slate-50 disabled:text-slate-400 ${
              icon ? 'pl-10' : 'pl-3.5'
