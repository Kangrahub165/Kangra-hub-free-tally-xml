    ...
    <div className="py-16 bg-navy-50 gradient-surface min-h-screen">
      <div className="max-w-4xl animate-fadeIn mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-5">
          ...
          {/* Section 1 */}
          <Card className="p-6 sm:p-7 border border-navy-200/60/90">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-brand-50 text-brand-700 flex items-center justify-center flex-shrink-0 border border-brand-200/60 shadow-glow-brand">
                <ShieldCheck className="w-5 h-5" />
              </div>
              <div>
                <h2 className="text-base font-bold text-navy-900 mb-1.5">
          ...
          <Card className="p-6 sm:p-7 border border-navy-200/60/90">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-amber-50 text-amber-700 flex items-center justify-center flex-shrink-0 border border-amber-200/60 shadow-glow-brand">
          ...
          <Card className="p-6 sm:p-7 border border-navy-200/60/90">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-700 flex items-center justify-center flex-shrink-0 border border-emerald-200/60 shadow-glow-brand">
          ...
          <Card className="p-6 sm:p-7 border border-navy-200/60/90">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-purple-50 text-purple-700 flex items-center justify-center flex-shrink-0 border border-purple-200/60 shadow-glow-brand">
